...
public class HomePage {
    ...
    public Optional<String> getLetterError(){
        return getWebErrorMsg(LETTER_ERROR);
    }

    public Optional<String> getSearchWarning(){
        return getWebErrorMsg(SEARCH_WARING);
    }

    public Optional<String> getPasswordError(){
        return getWebErrorMsg(PASSWORD_WARING);
    }

    public Optional<String> getCartWarning(){
        return getWebErrorMsg(Cart_WARING);
    }

    public Optional<String> getPasswordRight(){
        return getWebErrorMsg(PASSWORD_RIGHT);
    }
